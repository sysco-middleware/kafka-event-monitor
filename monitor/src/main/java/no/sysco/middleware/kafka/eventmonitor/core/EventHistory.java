 ...
 * <p>
 * This event will not include metadata indexing as it will increase cost of storage and increase
 * complexity. This could be delegated to source system, and id should be well defined.
 * <p>
...
public class EventHistory {
  ...
  public static EventHistory create(EventTransition eventTransition) {
    return new EventHistory(
        eventTransition.id,
        Collections.singletonList(new Transition(eventTransition.name, eventTransition.timestamp)));
  }
